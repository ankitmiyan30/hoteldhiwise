import 'controller/add_new_card_controller.dart';import 'package:demohotelbooking/core/app_export.dart';import 'package:demohotelbooking/widgets/app_bar/appbar_leading_image.dart';import 'package:demohotelbooking/widgets/app_bar/appbar_title.dart';import 'package:demohotelbooking/widgets/app_bar/custom_app_bar.dart';import 'package:demohotelbooking/widgets/custom_elevated_button.dart';import 'package:demohotelbooking/widgets/custom_text_form_field.dart';import 'package:flutter/material.dart';class AddNewCardScreen extends GetWidget<AddNewCardController> {const AddNewCardScreen({Key? key}) : super(key: key);
...
/// Section Widget
PreferredSizeWidget _buildAppBar() { return CustomAppBar(height: 52.v, leadingWidth: 52.h, leading: AppbarLeadingImage(imagePath: ImageConstant.imgArrowLeft, margin: EdgeInsets.only(left: 24.h, top: 11.v, bottom: 13.v), onTap: () {onTapArrowLeft();}), title: AppbarTitle(text: "lbl_add_new_card".tr, margin: EdgeInsets.only(left: 16.h))); } 
/// Section Widget
